...
public class SkeldPatcher : MonoBehaviour
{
    private void FixedUpdate()
    {
        ...
        TheOtherRolesPlugin.Logger.LogDebug("Patching TheSkeld...");
        ...
        TheOtherRolesPlugin.Logger.LogDebug("Placing vitals...");
        ...
        // Désactiver l'admin
        TheOtherRolesPlugin.Logger.LogDebug("Disabling admin...");
        ...
        TheOtherRolesPlugin.Logger.LogDebug("Rerouting vents...");
        ...
        TheOtherRolesPlugin.Logger.LogInfo("Successfully patched TheSkeld !");
