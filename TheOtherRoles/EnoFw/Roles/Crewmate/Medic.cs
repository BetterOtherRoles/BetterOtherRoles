...
public class Medic : AbstractRole
{
    ...
    // Options
    public readonly Option ShowMurderAttempt;
    public readonly Option WhenSetShield;
    public readonly Option WhenShowShield;
    public readonly Option ShowShield;

    public static Sprite ShieldButtonSprite => GetSprite("TheOtherRoles.Resources.ShieldButton.png", 115f);
