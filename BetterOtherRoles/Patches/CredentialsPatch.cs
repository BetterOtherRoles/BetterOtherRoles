...
namespace BetterOtherRoles.Patches
{
    ...
    public static class CredentialsPatch
    {
        ...
        public static readonly string FullVersionText = $"<color=#cc9e41>v{BetterOtherRolesPlugin.Version}</color>";
        ...
        public static class LogoPatch
        {
            ...
            public static void loadSprites()
            {
                if (bannerSprite == null)
                    bannerSprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Banner.png", 300f);
