...
namespace BetterOtherRoles {
    public class CustomOptionHolder {
        ...
        public static CustomOption SkeldO2Countdown;
        public static CustomOption SkeldReactorCountdown;
        ...
        public static void Load() {
            ...
            EnableBetterPolus = CustomOption.Create(5000, Types.General, "Better Polus", false, isHeader: true);
            PolusReactorCountdown = CustomOption.Create(5001, Types.General, "Polus Reactor Cooldown", 40f, 10f, 120f, 1f, isHeader: true, suffix: "s");
            
            EnableBetterSkeld = CustomOption.Create(5010, Types.General, "Better Skeld", false, isHeader: true);
            SkeldReactorCountdown = CustomOption.Create(5011, Types.General, "Skeld Reactor Cooldown", 40f, 10f, 120f, 1f, isHeader: true, suffix: "s");
            SkeldO2Countdown = CustomOption.Create(5012, Types.General, "Skeld O2 Cooldown", 40f, 10f, 120f, 1f, isHeader: true, suffix: "s");
