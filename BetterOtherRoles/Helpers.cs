...
namespace BetterOtherRoles
{
    ...
    public static class Helpers
    {
        ...
        public static Sprite loadSpriteFromResources(string path, float pixelsPerUnit)
        {
            ...
            {
                BetterOtherRolesPlugin.Logger.LogDebug("Error loading sprite from path: " + path);
            }
        ...
        public static unsafe Texture2D loadTextureFromResources(string path)
        {
            ...
            {
                BetterOtherRolesPlugin.Logger.LogDebug("Error loading texture from resources: " + path);
            }
        ...
        public static AudioClip loadAudioClipFromResources(string path, string clipName = "UNNAMED_TOR_AUDIO_CLIP")
        {
            ...
            {
                BetterOtherRolesPlugin.Logger.LogDebug("Error loading AudioClip from resources: " + path);
            }
        ...
        {
            return (DevMode.EnableDevMode && TORMapOptions.ghostsSeeInformation) || (CachedPlayer.LocalPlayer.PlayerControl != null &&
        ...
        public static void toggleZoom(bool reset = false)
        {
            ...
            if (HudManagerStartPatch.zoomOutButton != null)
            {
                HudManagerStartPatch.zoomOutButton.Sprite = zoomOutStatus
                    ? Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.PlusButton.png", 75f)
                    : Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.MinusButton.png", 150f);
