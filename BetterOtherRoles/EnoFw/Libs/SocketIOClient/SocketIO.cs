...
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.Exceptions;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.Extensions;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.JsonSerializer;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.Messages;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.Transport;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.Transport.Http;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.Transport.WebSockets;
using BetterOtherRoles.EnoFw.Libs.SocketIOClient.UriConverters;

namespace BetterOtherRoles.EnoFw.Libs.SocketIOClient;
