...
namespace BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Serialization;
...
{
    private static List<BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Serialization.UnsafeMessageConverter> MessageConverters { get; } = new();

    private static Dictionary<Type, BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Serialization.UnsafeMessageConverter?> MessageConverterMap { get; } = new();

    /// <summary>
    /// Registers a MessageConverter.
    /// </summary>
    /// <param name="messageConverter">The MessageConverter to be registered.</param>
    public static void Register(BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Serialization.UnsafeMessageConverter messageConverter)
    {
    ...
    public static BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Serialization.UnsafeMessageConverter? FindConverter(Type type)
    {
