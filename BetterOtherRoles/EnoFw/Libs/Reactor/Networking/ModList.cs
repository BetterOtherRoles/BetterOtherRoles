...
using BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Patches;
using Hazel;
...
public static class ModList
{
    ...
    private static void Refresh()
    {
        ...
        Current = IL2CPPChainloader.Instance.Plugins.Values
            ...
            .OrderByDescending(x => x.Id == BetterOtherRolesPlugin.Id)
        ...
        BetterOtherRolesPlugin.Logger.LogDebug(debug.ToString());
    }
