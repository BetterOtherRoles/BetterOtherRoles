...
namespace BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc;
...
public abstract class UnsafeCustomRpc
{
    ...
    /// <summary>
    /// Gets a value indicating whether the rpc is a singleton and can be used with <see cref="BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.Rpc{T}"/>.
    /// </summary>
    ...
    /// </summary>
    public abstract BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.RpcLocalHandling LocalHandling { get; }
    ...
    public void UnsafeSend(InnerNetObject innerNetObject, object? data, bool immediately = false, int targetClientId = -1, Action? ackCallback = null)
    {
        ...
        if (LocalHandling == BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.RpcLocalHandling.Before)
        {
        ...
        {
            false => AmongUsClient.Instance.StartRpc(innerNetObject.NetId, BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.CustomRpcManager.CallId, SendOption),
            true => AmongUsClient.Instance.StartRpcImmediately(innerNetObject.NetId, BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.CustomRpcManager.CallId, SendOption, targetClientId),
        };
        ...
        if (LocalHandling == BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.RpcLocalHandling.After)
        {
            UnsafeHandle(innerNetObject, data);
        }
    }
