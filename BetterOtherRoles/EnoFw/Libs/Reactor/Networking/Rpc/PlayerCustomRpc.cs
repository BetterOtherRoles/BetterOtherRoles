...
/// <summary>
/// Shorthand for <see cref="BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.CustomRpc{TPlugin,TInnerNetObject,TData}"/> with <see cref="PlayerControl"/> as the TInnerNetObject.
/// </summary>
...
public abstract class PlayerCustomRpc<TPlugin, TData> : BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.CustomRpc<TPlugin, PlayerControl, TData> where TPlugin : BasePlugin
{
    /// <inheritdoc />
...
/// <summary>
/// Shorthand for <see cref="BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.CustomRpc{TPlugin,TInnerNetObject}"/> with <see cref="PlayerControl"/> as the TInnerNetObject.
/// </summary>
/// <typeparam name="TPlugin">The type of the plugin the the rpc is attached to.</typeparam>
public abstract class PlayerCustomRpc<TPlugin> : BetterOtherRoles.EnoFw.Libs.Reactor.Networking.Rpc.CustomRpc<TPlugin, PlayerControl> where TPlugin : BasePlugin
{
    /// <inheritdoc />
    protected PlayerCustomRpc(TPlugin plugin, uint id) : base(plugin, id)
    {
