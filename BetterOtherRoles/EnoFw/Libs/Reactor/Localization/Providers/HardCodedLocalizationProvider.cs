...
namespace BetterOtherRoles.EnoFw.Libs.Reactor.Localization.Providers;
...
public sealed class HardCodedLocalizationProvider : LocalizationProvider
{
    ...
    public static void Register(StringNames stringName, string value)
    {
        ...
        {
            BetterOtherRolesPlugin.Logger.LogWarning($"Registering StringName {stringName} that already exists");
        }
