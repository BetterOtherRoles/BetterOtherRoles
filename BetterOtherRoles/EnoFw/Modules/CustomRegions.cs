...
public static class CustomRegions
{
    ...
    {
        new StaticHttpRegionInfo("Custom", StringNames.NoTranslation, BetterOtherRolesPlugin.Ip.Value,
                new Il2CppReferenceArray<ServerInfo>(new[]
                    { new ServerInfo("Custom", BetterOtherRolesPlugin.Ip.Value, BetterOtherRolesPlugin.Port.Value, false) }))
