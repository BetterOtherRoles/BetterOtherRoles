...
public class BountyHunter : AbstractRole
{
    ...
    // Options
    public readonly CustomOption BountyDuration;
    public readonly CustomOption BountyKillCooldown;
    public readonly CustomOption PunishmentTime;
    public readonly CustomOption ShowArrow;
    public readonly CustomOption ArrowUpdateInterval;
