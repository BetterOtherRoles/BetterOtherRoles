...
public class Detective : AbstractRole
{
    ...
    // Options
    public readonly CustomOption AnonymousFootprint;
    public readonly CustomOption FootprintInterval;
    public readonly CustomOption FootprintDuration;
    public readonly CustomOption ReportNameDuration;
    public readonly CustomOption ReportColorDuration;
