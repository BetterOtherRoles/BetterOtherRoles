...
public class Snitch : AbstractRole
{
    ...
    // Options
    public readonly CustomOption LeftTasksForReveal;
    public readonly CustomOption InfoMode;
    public readonly CustomOption InfoTargets;
    public readonly CustomOption ArrowTargets;
